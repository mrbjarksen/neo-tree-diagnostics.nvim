...
---@param start_loc table? The (0-indexed) starting position of the previewed text. May be absent.
---@param end_loc table? The (0-indexed) ending position of the previewed text. May be absent
